...
export const generateMetadata = pageTitle('Watiq National Portal - Accessibility Statement');
...
export default async function Page() {
  ...
  return (
    <ContentPage slug="accessibility" title="Accessibility Statement" ctx={ctx}>
